...
- ChainWeaver: [adapters/chainweaver_adapter.py](.https://github.com/w2jmoe/chainweaver-wisepick-adapter/blob/main/adapters/chainweaver_adapter.py) — guide: [chainweaver_adapter_readme.md](../adapters/chainweaver_adapter_readme.md)
